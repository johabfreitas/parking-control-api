...
public class ParkingSpotModel implements Serializable {
	...
	private static final long serialVersionUID = -5084757191864044459L;
	
	//Mapeando as atributos e gerando as colunas da tabela TB_PARKING_SPOT
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)
	private UUID id; // id gerado automático
	...
	private String apartment; // número do apto
